...
public class CringemacAuto extends LinearOpMode {
        ...
        if (!isStopRequested()){
            switch (level) {
                case 1:
                    ...
                    mDrive.BR.setPower(-0.5); //left strafe
                    sleep(350);
                    mDrive.FL.setPower(0.8);
                    mDrive.FR.setPower(-0.8);
                    mDrive.BL.setPower(0.8);
                    mDrive.BR.setPower(-0.8);
                    sleep(1050);
                    mDrive.Laft.setPower(-1);
                    sleep(250);
                    mDrive.Laft.setPower(0);
                ...
                case 2:
                    ...
                    mDrive.BR.setPower(-0.5); //left strafe
                    sleep(350);
                    mDrive.FL.setPower(0.75);
                    mDrive.FR.setPower(-0.75);
                    mDrive.BL.setPower(0.75);
                    mDrive.BR.setPower(-0.75);
                    sleep(850);
                    mDrive.Laft.setPower(-1);
                    sleep(500);
                    mDrive.Laft.setPower(0);
