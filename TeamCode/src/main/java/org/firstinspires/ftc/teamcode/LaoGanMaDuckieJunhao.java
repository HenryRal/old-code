...
@Autonomous(name="LaoGanMaDuckieJunhao", group="auto")
public class LaoGanMaDuckieJunhao extends LinearOpMode {
        ...
        if (!isStopRequested()){
            switch (level) {
                case 1:
                    ...
                    mDrive.FR.setPower(0);
                    mDrive.BR.setPower(0);
                    linearMovement(4, 1, 0.0004,0.00007, 0.000068);
                    mDrive.Duckie.setPower(-0.1);
                    sleep(3500);
